...
<head>
    ...
    <meta name="description" content="PlayCollection Déconnexion" />
    <meta name="keywords" content="" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>PlayCollection Déconnexion</title>
        ...
        <div class="row">
            <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item " href='<?php echo base_url();?>index.php/controllerAccueilCollectionneur/index'>Home</a>
                                <a class="dropdown-item " href='<?php echo base_url();?>index.php/controlleurListePerso/index'>Your list</a>
                                <a class="dropdown-item active" href='<?php echo base_url();?>index.php/controllerDecoCo/index'>Logout</a>
                            </div>
                        </div>
