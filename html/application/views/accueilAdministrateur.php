...
<head>
    ...
    <meta name="description" content="PlayCollection AccueilAdministrateur" />
    <meta name="keywords" content="" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>PlayCollection AccueilAdministrateur</title>
        ...
        <div class="row">
            <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item active" href='<?php echo base_url();?>index.php/controllerAccueilAdministrateur/index'>Home</a>
                                <a class="dropdown-item" href='<?php echo base_url();?>index.php/controllerDecoAd/index'>Logout</a>
                            </div>
                        </div>
